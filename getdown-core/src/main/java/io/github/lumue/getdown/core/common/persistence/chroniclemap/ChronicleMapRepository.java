...
public abstract class ChronicleMapRepository<B extends ObjectBuilder<V>, K, V extends HasIdentity<K>> implements
	...
	public ChronicleMapRepository(String filename) {
